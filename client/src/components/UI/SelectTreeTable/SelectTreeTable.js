...
import './SelectTreeTable.css';
import selectTableHOC from 'react-table/lib/hoc/selectTable';
import treeTableHOC from 'react-table/lib/hoc/treeTable';

const TreeTable = selectTableHOC(treeTableHOC(ReactTable));
...
class SelectTreeTable extends Component {
  constructor(props) {
    super(props);
  ...
  toggleTree = () => {
    if (this.state.pivotBy.length) {
      ...
      this.setState({ pivotBy: ['domaine'], expanded: {} });
    }
  };
      ...
      <div>
        ...
        {this.state.data ? (
          <TreeTable
            ...
            className="hidden -highlight -striped"
            {...extraProps}
            defaultPageSize={10}
